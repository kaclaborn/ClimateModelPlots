...
source.label.gutschow.AnnexII <- "Source: Gütschow et al (2020). <https://doi.org/10.5281/zenodo.3638137>\nNote:     Iceland and New Zealand removed from analysis due to relative low emissions levels;\n             Units in gigatonnes (Gt) CO2e"
